# cloud-itonami-municipality-ind-new-delhi

Municipal-ordinance compliance catalog for **New Delhi** — the
TWENTY-EIGHTH municipality-level entry alongside
...
Municipal Corporation of Delhi (MCD, out of scope here). This is the
same federal-district-style special-jurisdiction pattern already used
for
[`cloud-itonami-municipality-usa-washington-dc`](https://github.com/cloud-itonami/cloud-itonami-municipality-usa-washington-dc).
...
actuation actor. It proposes or executes nothing on NDMC's behalf.
...
Both entries cite official [ndmc.gov.in](https://www.ndmc.gov.in/)
HTML pages (the raw PDF equivalents rendered with an illegible,
font-subsetted header): **The New Delhi Municipal Council Act, 1994**
(Act No. 44 of 1994, title confirmed via `act.aspx`, the exact
citation independently corroborated by a separate bye-law's own
preamble text, assent date 1994-07-14 WebSearch-corroborated) and
**The New Delhi Municipal Council (Licensing and Control of Plumbers)
Bye-laws, 2006** (title and preamble directly confirmed; no precise
commencement date is stated in the document body itself, so
`:ordinance/enacted-date` is deliberately omitted).
...
festivals and heritage sites for New Delhi:
...
itself remains NDMC's; this repo stores only citation metadata
